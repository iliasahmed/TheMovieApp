package com.iliasahmed.testappforhandymama.ui.nowPlaying
...
class NowPlayingFragment : Fragment() {
    ...
    lateinit var nowPlayingMovieList: List<MovieModel>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        movieViewModel.movieLiveData.observe(this, Observer<List<MovieModel>> {
            ...
            (nowPlayingMovieList as ArrayList<MovieModel>).addAll(it)
    ...
    private fun initRecyclerView() {
        ...
        rvNowPlaying.layoutManager = glm
        adapter = MovieAdapter(nowPlayingMovieList, this.activity!!)
        rvNowPlaying.addItemDecoration(RecyclerViewItemDecorator(2, RecyclerViewItemDecorator.dpToPx(context!!, 10), true))
    ...
    private fun callNowPlayingMovieApi(page: Int) {
        showLoading()
        movieViewModel.fetchNowPlayingMovie(page)
    }
